...
class MineruClient:
    ...
    def convert_pdf(
        ...
        """Upload a PDF, poll until extraction finishes, return Markdown.
        ...
        return _download_and_extract_markdown(zip_url)
...
def _download_and_extract_markdown(zip_url: str) -> str:
    """Download a ZIP from zip_url and return the first .md file's content."""
    ...
    with zipfile.ZipFile(io.BytesIO(resp.content)) as zf:
        ...
        if not md_files:
            raise MineruError(
                f"No .md file found in result ZIP from {zip_url}. "
